$(function() {
    ...
    demo_settings.append(
            ...
            + "<div id='skincontroll' class='form-group no-margin'>"
    		+ "<div class='form-group no-margin'>"
            + "<div class='.radio'>"
            + "<label>"
            + "<input id='skin_black' name='skins' type='radio' onchange='change_skin(\"skin-black\");' /> "
            + "Black"
            + "</label>"
            + "</div>"
            + "</div>"
            ...
            + "<div class='.radio'>"
            + "<label>"
            + "<input id='skin_blue' name='skins' type='radio' onchange='change_skin(\"skin-blue\");' checked='checked'/> "
            + "Blue"
            + "</label>"
            + "</div>"
            + "</div>"
